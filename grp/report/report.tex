...
There has been less research performed with the intention of reversing the problem and receiving optimized geometry parameters from desired antenna performance values. Xiao et al.~applied an inverse ANN in an attempt to solve this problem,~\cite{XiaoLi-Ye2021IANN}.
